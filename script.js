...
// ── Video registry ────────────────────────────────────────
const videoMeta = {
    featured1: { id: '1NInV19MR3Q', type: 'youtube', title: 'THE PRICE OF GREATNESS',
                 tag: 'FEATURED PROJECT', desc: 'A short video essay reframing two stories we thought we knew: Arjun\'s bird\'s-eye and Andrew\'s bloodied drumset, told as the same warning twice. The script makes the argument; the edit carries it. Hand-curated cinematic visuals, a score that shifts with the mood, and a typographic pairing — clean white against accent yellow — where even two words on screen are made to hit.',
                 meta: [['Runtime','5:58'],['Days in Edit','4+'],['Script + Cut','Yours Truly']] },
    p1:        { id: 'GXsNEZdMbBc', type: 'youtube', title: 'WHEN GOOD TASTE BECOMES A CURSE',
                 tag: 'CINEMA ESSAY', desc: 'A video essay about the gap — the one between what you can make and what you wish you could make. Built from the inside of that gap, while still inside it. Pop-culture footage, raw text on screen, and a script that doesn\'t pretend to have the answer. This one\'s less argument, more confession.',
                 meta: [['TYPE','VIDEO ESSAY'],['FORMAT','LONG-FORM'],['CATEGORY','PERSONAL']] },
    p2:        { id: 'Jq9D1OiQO6c', type: 'youtube', title: "THE COST OF BEING SPIDER-MAN (AND WHY MARVEL WON'T PAY IT)",
                 tag: 'CHARACTER ESSAY', desc: 'Marvel loves Spider-Man because he sells. We love Spider-Man because he struggles. A long-form critique of an industry that keeps reaching for the costume without paying the cost — argued through split-screens, paired typography, and visuals that land the emotional beat before the script does. Personal, because Peter has always been personal.',
                 meta: [['TYPE','VIDEO ESSAY'],['FORMAT','LONG-FORM'],['CATEGORY','CHARACTER STUDY']] },
    p3:        { id: 'rds2D-koeRA', type: 'youtube', title: 'CHALCHITRA GATHA',
                 tag: 'HERITAGE DOC', desc: 'A documentary on the fade-out of India\'s single-screen theatres — cut in black-and-white to sit with the nostalgia, then handing color back only at the end, when the film lets in a sliver of hope. Edited for an old friend\'s vision; the concept was his, the rhythm was mine to find.',
                 meta: [['TYPE','DOCUMENTARY'],['FORMAT','LONG-FORM'],['CATEGORY','TRIBUTE']] },
    p4:        { id: 'lYLvPzTBSVE', type: 'youtube', title: 'VISHWAAYAN 2023 — FEST AFTER MOVIE',
                 tag: 'LIVE-EDIT FILM', desc: 'A same-day fest film — shot, cut, and screened before the night was over. Footage was handed off from camera to timeline while the event was still happening, and the final piece played in front of the full college and the dean by closing. Credited on the cinematography team; unofficial second chair in the edit bay — the kind of role where you don\'t sign the cut, but you sit close enough to shape it.',
                 meta: [['TYPE','EVENT FILM'],['FORMAT','LONG-FORM'],['CATEGORY','COLLABORATIVE']] },
    p5:        { id: '7rNf4TygTEw', type: 'youtube', title: "META QUEST 3 REVIEW: WHY ISN'T ANYONE TALKING ABOUT THIS VR HEADSET!?",
                 tag: 'TECH REVIEW', desc: 'A long-form tech review built around the question its title asks — and edited to keep you in the room while it answers. A crafted cold open to earn the first thirty seconds, masking and movement tricks across the body to keep the pace honest, and a closer scored to send you out on a high. The headset\'s the subject; the edit\'s the argument for staying.',
                 meta: [['TYPE','TECH REVIEW'],['FORMAT','LONG-FORM'],['CATEGORY','CRAFT SHOWCASE']] },
    p6:        { id: 'NIIqW-gSDLk', type: 'youtube', title: 'A ONE MINUTE STORY',
                 tag: 'SHORT FILM', desc: 'A one-minute short about a guy drowning in the scroll who steps outside, makes a cup of chai, and lets the world slow down. The first half is built loud — rapid cuts, layered sound design, the texture of overstimulation. The second half exhales. A match cut from a cup on a table to a cup on the terrace marks the turn, and the score lifts with it. The cut is the story; the chai is the punchline.',
                 meta: [['TYPE','SHORT FILM'],['FORMAT','CINEMATIC'],['CATEGORY','NARRATIVE']] },
    p7:        { id: '_NA9OHg8RC0', type: 'youtube', title: 'KUMSS PROMO',
                 tag: 'BRAND PROMO', desc: 'A 44-second promo for KUMSS — an educational group of seven institutes under one banner. Built in After Effects with motion graphics doing the lifting: information flowing in and out on cue, layout treated like a presentation rather than a montage, every beat timed to land a fact before moving on. The brief was to make seven institutes feel like one story. The edit made them feel like one campus.',
                 meta: [['TYPE','BRAND PROMO'],['FORMAT','MOTION GRAPHICS'],['CATEGORY','EDUCATIONAL PROMO']] },
    p8:        { id: 'g8QpxHtQKbM', type: 'youtube', title: "WHEN THERE'S NOTHING TO EAT AT HOME",
                 tag: 'SHORT FILM', desc: 'A one-minute short about hunger that isn\'t really about hunger. A guy works, gets bored, opens the fridge, finds nothing, rides out for a nariyal pani, comes back, gets to work — and opens the fridge again. The shots do the talking: a phone wedged inside the fridge, inside drawers, mounted for the bike ride — every angle earned with whatever was at hand. Light tone, light score, a closing card that lands the twist in two words: never satisfied.',
                 meta: [['TYPE','SHORT FILM'],['FORMAT','CINEMATIC'],['CATEGORY','NARRATIVE']] },
    ...
    h1:        { id: 'E8WvVFB7klo', type: 'youtube', title: 'AGYAAT: A One-Minute Horror Short Film',
                 tag: 'ABSOLUTE CINEMA', desc: 'A one-minute horror short pulled together with whatever we had. Gel papers taped over lights for color. A pedestal fan standing in for ambient dread. A hairdryer to blow out the candles on cue. Shot on a phone, in the dark, with intent — because atmosphere doesn\'t need a budget, it just needs some jugaad.',
                 meta: [['TYPE','HORROR SHORT'],['TONE','UNSETTLING'],['FOCUS','ATMOSPHERE']] },
    h2:        { id: '5E8WE2xhMqU', type: 'youtube', title: 'DUST OFF: A Cinematic Bike Film',
                 tag: 'ABSOLUTE CINEMA', desc: 'A cinematic bike film built on three pillars: a color grade that creates its own world, cinematography that finds an angle no one else would, and music cut so tight to the visuals you feel the ignition before you hear it. If this is what mobile can capture in the right hands, imagine what the right workflow can do next.',
                 meta: [['TYPE','CINEMATIC SHORT'],['TONE','KINETIC'],['FOCUS','CRAFT']] },
};
